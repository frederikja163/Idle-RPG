...
import { cn } from '@/front-end/lib/utils.ts';
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'bg-popover text-popover-foreground data-[store=open]:animate-in data-[store=closed]:animate-out data-[store=closed]:fade-out-0 data-[store=open]:fade-in-0 data-[store=closed]:zoom-out-95 data-[store=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border shadow-md',
          position === 'popper' &&
